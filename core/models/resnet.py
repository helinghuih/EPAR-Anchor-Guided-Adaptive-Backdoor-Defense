...
class _ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        # Adaptive pooling supports both CIFAR-size 32x32 inputs and
        # Tiny-ImageNet-size 64x64 inputs without changing feature dimension.
    ...
    def _make_layer(self, block, planes, num_blocks, stride):
        ...
        for current_stride in strides:
            layers.append(
                block(self.in_planes, planes, current_stride)
            )
